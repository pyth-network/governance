...
- **Pythian Council Ops Multisig Wallet:** Squad Multisig wallet, at the following address `GAdn7TZhszf5KTfwNRx3A2nP6KCRFEWucZubgdEqbJA2`, signed by the elected members of the Pythian Council. The Pythian Council is described in further detail below.
...
The Pythian Council is made of 8 members who are signers of the Pythian Multisig Wallet and the Pythian Council Ops Multisig Wallet.  The Pythian Multisig Wallet has powers to perform actions that are delegated to it by the Pyth DAO via OP-PIPs. The composition of the Pythian Council should be geographically diverse in furtherance of the ethos, mission and guiding values of the Pyth DAO. The execution of such actions by the Pythian Council requires 7-of-9 approval (with one of the default multisig holders being the Operations Wallet itself). The on-chain submission of a PIP using the Operations Wallet carries one vote in favour of the PIP. The Pythian Council Ops Multisig Wallet has powers to perform actions that are delegated to it by the Pyth DAO via OP-PIPs. The execution of such actions by the Pythian Council requires 6-of-8 approval (there is no Operations Wallet in this set up).
