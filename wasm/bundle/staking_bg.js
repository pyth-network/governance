...
*/
export function getNextVesting(vestingSchedBorsh, currentTime, tokenListingTime) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(vestingSchedBorsh, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        int64CvtShim[0] = currentTime;
        const low1 = u32CvtShim[0];
        const high1 = u32CvtShim[1];
        int64CvtShim[0] = isLikeNone(tokenListingTime) ? BigInt(0) : tokenListingTime;
        const low2 = u32CvtShim[0];
        const high2 = u32CvtShim[1];
        wasm.getNextVesting(retptr, ptr0, len0, low1, high1, !isLikeNone(tokenListingTime), low2, high2);
        ...
        return r0 === 0 ? undefined : VestingEvent.__wrap(r0);
    } finally {
...
* @returns {BigInt}
*/
export function getUnvestedBalance(vestingSchedBorsh, currentTime, tokenListingTime) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(vestingSchedBorsh, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const low2 = u32CvtShim[0];
        const high2 = u32CvtShim[1];
        wasm.getUnvestedBalance(retptr, ptr0, len0, low1, high1, !isLikeNone(tokenListingTime), low2, high2);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
...
*/
export const PositionState = Object.freeze({ UNLOCKED:0,"0":"UNLOCKED",LOCKING:1,"1":"LOCKING",LOCKED:2,"2":"LOCKED",PREUNLOCKING:3,"3":"PREUNLOCKING",UNLOCKING:4,"4":"UNLOCKING", });
/**
*/
export class Constants {
    ...
    * @returns {string}
    */
    static VOTER_RECORD_SEED() {
        const ret = wasm.constants_VOTER_RECORD_SEED();
        return takeObject(ret);
    }
    /**
    * @returns {string}
    */
    static TARGET_SEED() {
        const ret = wasm.constants_TARGET_SEED();
        return takeObject(ret);
    }
    /**
    * @returns {string}
    */
    static MAX_VOTER_RECORD_SEED() {
        const ret = wasm.constants_MAX_VOTER_RECORD_SEED();
        return takeObject(ret);
    }
    /**
    * @returns {string}
    */
    static VOTING_TARGET_SEED() {
        const ret = wasm.constants_VOTING_TARGET_SEED();
        return takeObject(ret);
    }
    /**
    * @returns {string}
    */
    static DATA_TARGET_SEED() {
        const ret = wasm.constants_DATA_TARGET_SEED();
        return takeObject(ret);
    }
    /**
    * @returns {number}
    */
    static MAX_POSITIONS() {
        const ret = wasm.constants_MAX_POSITIONS();
        return ret >>> 0;
    }
    /**
    * @returns {number}
    */
    static POSITIONS_ACCOUNT_SIZE() {
        const ret = wasm.constants_POSITIONS_ACCOUNT_SIZE();
        return ret >>> 0;
    }
    /**
    * @returns {BigInt}
    */
    static MAX_VOTER_WEIGHT() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.constants_MAX_VOTER_WEIGHT(retptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            u32CvtShim[0] = r0;
            u32CvtShim[1] = r1;
    ...
    * @returns {number}
    */
    static POSITION_BUFFER_SIZE() {
        const ret = wasm.constants_POSITION_BUFFER_SIZE();
        return ret >>> 0;
    }
    /**
    * @returns {string}
    */
    static GOVERNANCE_PROGRAM() {
        const ret = wasm.constants_GOVERNANCE_PROGRAM();
        return takeObject(ret);
    }
}
/**
...
export class LockedBalanceSummary {
    ...
    static __wrap(ptr) {
        const obj = Object.create(LockedBalanceSummary.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_lockedbalancesummary_free(ptr);
    }
    /**
    */
    get locking() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_lockedbalancesummary_locking(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            u32CvtShim[0] = r0;
            u32CvtShim[1] = r1;
    ...
    */
    set locking(arg0) {
        ...
        wasm.__wbg_set_lockedbalancesummary_locking(this.ptr, low0, high0);
    }
    /**
    */
    get locked() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_lockedbalancesummary_locked(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            u32CvtShim[0] = r0;
            u32CvtShim[1] = r1;
    ...
    */
    set locked(arg0) {
        ...
        const low0 = u32CvtShim[0];
        const high0 = u32CvtShim[1];
        wasm.__wbg_set_lockedbalancesummary_locked(this.ptr, low0, high0);
    }
    /**
    */
    get unlocking() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_lockedbalancesummary_unlocking(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            u32CvtShim[0] = r0;
            u32CvtShim[1] = r1;
    ...
    */
    set unlocking(arg0) {
        ...
        const low0 = u32CvtShim[0];
        const high0 = u32CvtShim[1];
        wasm.__wbg_set_lockedbalancesummary_unlocking(this.ptr, low0, high0);
    }
    /**
    */
    get preunlocking() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_lockedbalancesummary_preunlocking(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            u32CvtShim[0] = r0;
            u32CvtShim[1] = r1;
    ...
    * @param {BigInt} arg0
    */
    set preunlocking(arg0) {
        uint64CvtShim[0] = arg0;
        const low0 = u32CvtShim[0];
        const high0 = u32CvtShim[1];
        wasm.__wbg_set_lockedbalancesummary_preunlocking(this.ptr, low0, high0);
    }
}
/**
...
export class VestingEvent {
    ...
    static __wrap(ptr) {
        const obj = Object.create(VestingEvent.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_vestingevent_free(ptr);
    }
    /**
    */
    get time() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_vestingevent_time(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            u32CvtShim[0] = r0;
            u32CvtShim[1] = r1;
    ...
    */
    set time(arg0) {
        ...
        const low0 = u32CvtShim[0];
        const high0 = u32CvtShim[1];
        wasm.__wbg_set_vestingevent_time(this.ptr, low0, high0);
    }
    /**
    */
    get amount() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.__wbg_get_vestingevent_amount(retptr, this.ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            u32CvtShim[0] = r0;
            u32CvtShim[1] = r1;
    ...
    */
    set amount(arg0) {
        ...
        const low0 = u32CvtShim[0];
        const high0 = u32CvtShim[1];
        wasm.__wbg_set_vestingevent_amount(this.ptr, low0, high0);
    }
}
/**
*/
export class WasmPositionData {
    ...
    static __wrap(ptr) {
        const obj = Object.create(WasmPositionData.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmpositiondata_free(ptr);
    }
    /**
    ...
    */
    constructor(buffer) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.wasmpositiondata_from_buffer(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
            ...
            return WasmPositionData.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    ...
    * @returns {number}
    */
    getPositionState(index, current_epoch, unlocking_duration) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            uint64CvtShim[0] = current_epoch;
            const low0 = u32CvtShim[0];
            const high0 = u32CvtShim[1];
            wasm.wasmpositiondata_getPositionState(retptr, this.ptr, index, low0, high0, unlocking_duration);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    * @returns {boolean}
    */
    isPositionVoting(index) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmpositiondata_isPositionVoting(retptr, this.ptr, index);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    getLockedBalanceSummary(current_epoch, unlocking_duration) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            uint64CvtShim[0] = current_epoch;
            const low0 = u32CvtShim[0];
            const high0 = u32CvtShim[1];
            wasm.wasmpositiondata_getLockedBalanceSummary(retptr, this.ptr, low0, high0, unlocking_duration);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
            ...
            return LockedBalanceSummary.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    ...
    * @returns {BigInt}
    */
    getWithdrawable(total_balance, unvested_balance, current_epoch, unlocking_duration) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            uint64CvtShim[0] = total_balance;
            const low0 = u32CvtShim[0];
            const high0 = u32CvtShim[1];
            uint64CvtShim[0] = unvested_balance;
            const low1 = u32CvtShim[0];
            const high1 = u32CvtShim[1];
            uint64CvtShim[0] = current_epoch;
            const low2 = u32CvtShim[0];
            const high2 = u32CvtShim[1];
            wasm.wasmpositiondata_getWithdrawable(retptr, this.ptr, low0, high0, low1, high1, low2, high2, unlocking_duration);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
    ...
    * @returns {BigInt}
    */
    getVoterWeight(current_epoch, unlocking_duration, current_locked) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            uint64CvtShim[0] = current_epoch;
            const low0 = u32CvtShim[0];
            const high0 = u32CvtShim[1];
            uint64CvtShim[0] = current_locked;
            const low1 = u32CvtShim[0];
            const high1 = u32CvtShim[1];
            wasm.wasmpositiondata_getVoterWeight(retptr, this.ptr, low0, high0, unlocking_duration, low1, high1);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
...
export class WasmTargetMetadata {
    ...
    static __wrap(ptr) {
        const obj = Object.create(WasmTargetMetadata.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmtargetmetadata_free(ptr);
    }
    /**
    * @param {Uint8Array} buffer
    */
    constructor(buffer) {
        try {
            ...
            const ptr0 = passArray8ToWasm0(buffer, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            wasm.wasmtargetmetadata_from_buffer(retptr, ptr0, len0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
            ...
            return WasmTargetMetadata.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    ...
    * @returns {BigInt}
    */
    getCurrentAmountLocked(current_epoch) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            uint64CvtShim[0] = current_epoch;
            const low0 = u32CvtShim[0];
            const high0 = u32CvtShim[1];
            wasm.wasmtargetmetadata_getCurrentAmountLocked(retptr, this.ptr, low0, high0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            var r3 = getInt32Memory0()[retptr / 4 + 3];
